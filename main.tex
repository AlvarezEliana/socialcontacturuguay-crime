...
\begin{figure}[H]
	\centering
	\includegraphics[width=.75\textwidth]{evo_delitos.pdf}
	\caption{Number of homicides and assaults in Uruguay. 1980 -- 2018. Source: Observatorio de Violencia y Criminalidad del Ministerio del Interior. For years 1993 and 1994 annual data was not publish. } \label{fig:homrap19802017}
\end{figure}
...
3	      &	Sellers (wholetime \&	&	Placebo	&	Effect if it is about selling. 	\\
	      &	dropouts \& newcomers)	&		&	Effect if the decision is about selling or No effect if it is about decision of selling	\\
...
Perceived impact on individual liberties	&	.3605769	&	.1763803	&	 0.0459**	&	 .0068029     .714351		\\
