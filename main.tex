...
\section[]{Laws, Social Goods, and the Sale of Marijuana in Neighborhoods in Uruguay}
...
The most important distinction among sellers and non-sellers is concerning opinions towards the public policy. Owners and representatives of pharmacies that decided to sell are consistently more in favor of the regulation and anticipate it would have more positive impacts. Balance test (see Table \ref{tab:pharmaciesperceptions} in Appendix A) show statistically significant differences between sellers and non-sellers among almost all outcomes related with policy opinions. The only exception is the perceived impact on drug trafficking in which there are significant differences. In addition sellers are significantly more against the idea that marijuana is a gateway drug than non sellers. 
