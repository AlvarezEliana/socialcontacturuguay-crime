...
nsecdist <- match_on(soldvsnot17 ~ n_sec_i_mean, data = dat17p)
nsecdist[1:5, 1:5]
...
Use three possible solutions: (1) overall balancing effective sample size while dropping few control obs, (2) simply maximizing comparison  with  a block randomized experiment, (3) not dropping any obs.
