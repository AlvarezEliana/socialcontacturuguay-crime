...
```{r penalizedistmats}
mhdistPen <- mhdist + (pdist > pcal) * maxmh + (mhdist > mcal) * maxmh + (crimedist > crimecal)*maxmh## Penalty like Rosenbaum
psdistPen <- pdist + (pdist > pcal) * maxps + (mhdist > mcal) * maxps + (crimedist >  crimecal)*maxps ## Penalty like Rosenbaum
...
Also look at MSEs: fm2 marginally better
