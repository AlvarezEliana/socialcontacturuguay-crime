...
pharmacies might have been allocated at random.
 ...
 In our case, the raw comparison
...
randomized experiment: an omnibus balance test [@hansen2008cbs] across `r nrow(initial_omnibus_bal@statistic@linearstatistic)` covariates
reports a $p$-value of `r pvalue(initial_omnibus_bal)[[1]]`.
