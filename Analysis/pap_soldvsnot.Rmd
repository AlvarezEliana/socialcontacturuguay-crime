...
TODO Describe the collaboration with the government that gave us access to the
lists of pharmacies that were confidential to the public.
...
(see Table \ref{tab:pharmsalestatus}).
...
observational study.  \citet{hansen2008cbs} develop a formal way to compare a
...
influence of unobserved covariates.\footnote{See \citep[Chapter
3]{rosenbaum2010design} for an overview of this method of sensitivity analysis.}
...
and assign the mean value \citep{goertz2006social}.
